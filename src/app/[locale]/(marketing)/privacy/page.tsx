...
export const metadata = {
    title: "Privacy Policy - PodVid",
    description: "Privacy Policy for PodVid",
};
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
                {locale === "zh" ? (
                    <>
                        ...
                        <h2>1. 引言</h2>
                        <p>
                            PodVid（"我们"）非常重视您的隐私。本隐私政策说明了当您使用我们的服务时，我们如何收集、使用、披露和保护您的信息。
                        </p>
                        ...
                        <h2>9. 联系我们</h2>
                        <p>
                            如果您对本隐私政策有任何疑问，请联系我们：privacy@podvid.uk
                        </p>
                    </>
                ) : (
                    <>
                        ...
                        <p>
                            PodVid ("we" or "us") values your privacy. This Privacy Policy explains how we collect, use, disclose, and protect your information when you use our services.
                        </p>
                        ...
                        <h2>9. Contact Us</h2>
                        <p>
                            If you have any questions about this Privacy Policy, please contact us at: privacy@podvid.uk
                        </p>
                    </>
                )}
            </div>
